...
Old installed clients can retain an already loaded release. After finishing any active workout, close all tracker tabs/windows and reopen the public URL. App 7.17 exposes its build and an update check in Settings; future waiting updates can be activated there. Do not clear site storage to update the code.
